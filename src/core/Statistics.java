...
public class Statistics {
    ...
    private AtomicInteger unsafePeople;
    private AtomicInteger diedToDiease;
    private AtomicInteger diedToWar;
    private AtomicInteger diedToAging;

    private AtomicInteger c_unsafePeople;


    private ConcurrentMap<String, Integer> populations;
    private ConcurrentMap<String, Integer> strengths;

    private ConcurrentMap<String, Integer> c_strengths;
    private ConcurrentMap<String, Integer> c_populations;
    public Statistics(){
